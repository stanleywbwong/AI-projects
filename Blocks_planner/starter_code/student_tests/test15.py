...
steps.append(Step(3,"move b a c",[Condition(True,"on b a"), Condition(True,"clear c"), Condition(True,"clear b")],[ Condition(True,"on b a"), Condition(False, "on b a"), Condition(True,"clear a"), Condition(False, "clear c")]))
...
ordering_constraints.append([3,5,2,1])
