...
steps.append(Step(1, "finish", [Condition(True, "on e table4"), Condition(True, "on a b"), Condition(True, "on b c"), Condition(True, "on c d"), Condition(True, "on d table1"), Condition(True, "clear a"), Condition(True, "clear table0"), Condition(True, "clear table2")], []))
...
steps.append(Step(6, "move e table3 table4", [Condition(True, "on e table3")], [Condition(True, "on e table4")]))
...
causal_links.append(Link(6, 1, Condition(True, "on e table4")))
